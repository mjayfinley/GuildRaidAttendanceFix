...
L["Save encounter info?"] = "保存首领战信息？"
L["Failed to save encounter info."] = "未能成功保存首领战信息。"
...
L["Sort attendance sheet by attendance (30 days)."] = "按出勤次数（30 天）排列出勤表。"
